      ...
      @if ($errors->any())
			...
			<div class='max-w-md mx-auto space-y-6'>
				...
				<form action="/category/{{$category->id}}" method="POST">
					...
					<input value="{{$category->name}}" name="name" type="text" class="p-3 mt-2 mb-4 w-full bg-slate-200 rounded border-2 border-slate-200 focus:border-slate-600 focus:outline-none">
					<Button
                                type="submit"
