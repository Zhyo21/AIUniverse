    ...
    <div class="pt-5">
        ...
        <div  class=" bg-white sm:mx-32 lg:mx-32 xl:mx-72 ">
            ...
            <div class="flex justify-center container mx-auto">
                <div class="w-full">
                    <div class="mt-4 px-4">
                        <h1 class="text-3xl font-semibold py-7 px-5">Add An AI Website</h1>
                   
                        <form class="mx-5 my-5" action="/website" method="POST" enctype="multipart/form-data">
                            @csrf
                            <label class="relative block p-3 border-2 border-black rounded" htmlFor="name">
                                ...
                                <input class="w-full bg-transparent p-0 text-sm  text-gray-500 focus:outline-none"
                                    id="name" type="text" placeholder="Website name" name="title" />
                            </label>
                            ...
                            <label class="relative block p-3 border-2 border-black rounded mt-3" htmlFor="name">
                                ...
                                <input class="w-full bg-transparent p-0 text-sm  text-gray-500 focus:outline-none"
                                    id="name" type="text" placeholder="Website Url" name="url" />
                            </label>
                          
                            <div class="w-full flex flex-wrap justify-between ">
                            <div>
                                <div class="shrink-0 mt-5 flex justify-start w-full ">
                                    <img class="h-50 w-50 object-cover" src="{{ asset('imgs/600x400.png') }}"
                            ...
                            <label class="relative block p-3 border-2 mt-5 border-black rounded w-[30rem]" htmlFor="name">
                                ...
                                <textarea
                                    ...
                                    id="name" type="text" placeholder="Write Website's  Desicription" name="desc"></textarea>
                            </label>
                            </div>
                            ...
                            <h1 class="text-2xl font-semibold mt-8">Category :</h1>
